--
-- Migration: 20260912230000_backfill_project_facts.sql
-- Populates initial client, consultant, scope, capacity, year, region facts for all 43 existing projects from project-meta.ts
--
BEGIN;
...
SET client_en = COALESCE(client_en, 'National Service Projects Organizations'),
    ...
    scope_ar = COALESCE(scope_ar, 'تصنيع شاسيهات · وحدات تناضح عكسي · فلترة أولية · تشغيل متعدد المواقع'),
