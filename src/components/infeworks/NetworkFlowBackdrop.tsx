    ...
    <div className="absolute inset-0 z-0 overflow-hidden bg-[#070e1a] pointer-events-none select-none">
      ...
      <div className="absolute inset-0 w-full h-full overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(0, 200, 213, 0.45) 0%, rgba(0, 200, 213, 0.15) 45%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(176, 94, 42, 0.45) 0%, rgba(176, 94, 42, 0.15) 45%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(15, 60, 140, 0.5) 0%, rgba(15, 60, 140, 0.2) 50%, transparent 75%)",
      ...
      <div 
        ...
        style={{
          ...
          WebkitMaskImage: "radial-gradient(ellipse 90% 70% at 50% 50%, #000 60%, transparent 100%)",
        }}
      />
    </div>
  );
